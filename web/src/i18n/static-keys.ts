...
export const STATIC_I18N_KEYS = [
  ...
  'API usage records',
  'Token Usage',
  'Token Usage by Token',
  'API Token Summary',
  'Token Details',
  'Channel Summary',
  'Models in Channel',
  'Selected',
  'Click a channel to see its models.',
  'Click to see models in this channel.',
  'Only models from the selected channel are shown.',
  'Raw value: {{value}}',
  'Usage Trend',
  'Daily input and output tokens',
  'Daily input and output token trend',
  'Peak daily total',
  'Days shown',
  'No trend data in this range.',
  'API Token Distribution',
  'Share of total tokens by API token',
  'No token distribution in this range.',
  'Distribution is calculated at API token level only.',
  'Input / Output',
  'of total',
  'Channel and Model Details',
  'Date range',
  'Today',
  'Yesterday',
  'This Week',
  ...
  'Last Month',
  'This Quarter',
  'No consumption logs in this range.',
  'Try selecting a different time range.',
  'No tokens in this range.',
  'Select a token to see channel details.',
  'No channel usage for this token.',
  'No model usage for this channel.',
